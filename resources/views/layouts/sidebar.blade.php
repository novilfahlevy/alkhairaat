...
<aside id="sidebar"
    class="fixed flex flex-col mt-0 top-0 px-5 left-0 bg-white dark:bg-gray-900 dark:border-gray-800 text-gray-900 h-screen transition-all duration-300 ease-in-out z-999 border-r border-gray-200"
    x-data="{
        openSubmenus: {},
        init() {
        ...
        initializeActiveMenus() {
            ...
            @foreach ($menuGroups as $groupIndex => $menuGroup)
                @if (MenuHelper::hasVisibleItems($menuGroup['items']))
                    ...
                    @if (MenuHelper::hasVisibleItems($menuGroup['items']))
                        <div>
                            ...
                            <ul class="flex flex-col gap-1">
                                @foreach (MenuHelper::filterItemsByRole($menuGroup['items']) as $itemIndex => $item)
                                    <li>
                                        @if (isset($item['subItems']))
