<header
    class="sticky top-0 flex w-full bg-white border-gray-200 z-50 dark:border-gray-800 dark:bg-gray-900 xl:border-b overflow-visible"
    x-data="{
            ...
            {{-- <div class="hidden xl:block">
                <form>
                    <div class="relative">
                        ...
                        <input type="text" placeholder="Cari murid, alumni, atau sekolah..."
