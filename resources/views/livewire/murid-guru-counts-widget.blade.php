<div class="space-y-4 sm:space-y-6">
    ...
    <x-ui.card>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 lg:gap-4">
            <!-- Total Murid -->
            <div
                class="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900 dark:to-blue-800 rounded-lg p-3 sm:p-4 lg:p-6 border border-blue-200 dark:border-blue-700 sm:col-span-2 md:col-span-2">
                <div class="flex items-center justify-between gap-2">
                    <div class="min-w-0">
                        <p class="text-xs sm:text-sm font-medium text-blue-600 dark:text-blue-300 uppercase tracking-wide truncate">Total
                            Murid
                        </p>
            ...
            <div
                ...
                <div class="flex items-center justify-between gap-2">
                    ...
                    <i class="fas fa-check-circle text-3xl sm:text-4xl text-green-300 dark:text-green-600 flex-shrink-0"></i>
                </div>
            </div>
            ...
            <div
                ...
                <div class="flex items-center justify-between gap-2">
                    <div class="min-w-0">
                        <p class="text-xs sm:text-sm font-medium text-purple-600 dark:text-purple-300 uppercase tracking-wide truncate">
                            Alumni</p>
                        <p class="text-2xl sm:text-3xl font-bold text-purple-800 dark:text-purple-100 mt-1">
                            {{ number_format($counts['murid']['alumni']) }}</p>
                    </div>
                    <i class="fas fa-graduation-cap text-3xl sm:text-4xl text-purple-300 dark:text-purple-600 flex-shrink-0"></i>
                </div>
            </div>

            <!-- Murid Laki-laki -->
            <div class="bg-gradient-to-br from-cyan-50 to-cyan-100 dark:from-cyan-900 dark:to-cyan-800 rounded-lg p-3 sm:p-4 lg:p-6 border border-cyan-200 dark:border-cyan-700">
                <div class="flex items-center justify-between gap-2">
                    <div class="min-w-0">
                        <p class="text-xs sm:text-sm font-medium text-cyan-600 dark:text-cyan-300 uppercase tracking-wide truncate">
                            Laki-laki
                        </p>
            ...
            <!-- Murid Perempuan -->
            <div class="bg-gradient-to-br from-rose-50 to-rose-100 dark:from-rose-900 dark:to-rose-800 rounded-lg p-3 sm:p-4 lg:p-6 border border-rose-200 dark:border-rose-700">
                <div class="flex items-center justify-between gap-2">
                    <div class="min-w-0">
                        <p class="text-xs sm:text-sm font-medium text-rose-600 dark:text-rose-300 uppercase tracking-wide truncate">
                            Perempuan
                        </p>
    ...
    <x-ui.card>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 lg:gap-4">
            ...
            <div
                ...
                <div class="flex items-center justify-between gap-2">
                    <div class="min-w-0">
                        <p class="text-xs sm:text-sm font-medium text-indigo-600 dark:text-indigo-300 uppercase tracking-wide truncate">Total
                            Guru
                        </p>
                        <p class="text-2xl sm:text-3xl font-bold text-indigo-800 dark:text-indigo-100 mt-1">
                            {{ number_format($counts['guru']['total']) }}</p>
                    </div>
                    <i class="fas fa-chalkboard-user text-3xl sm:text-4xl text-indigo-300 dark:text-indigo-600 flex-shrink-0"></i>
                </div>
            </div>
            ...
            <div
                ...
                <div class="flex items-center justify-between gap-2">
                    <div class="min-w-0">
                        <p class="text-xs sm:text-sm font-medium text-emerald-600 dark:text-emerald-300 uppercase tracking-wide truncate">
                            Aktif</p>
                        <p class="text-2xl sm:text-3xl font-bold text-emerald-800 dark:text-emerald-100 mt-1">
                            {{ number_format($counts['guru']['aktif']) }}</p>
                    </div>
                    <i class="fas fa-circle-check text-3xl sm:text-4xl text-emerald-300 dark:text-emerald-600 flex-shrink-0"></i>
                </div>
            </div>

            <!-- Guru Tidak Aktif -->
            <div class="bg-gradient-to-br from-red-50 to-red-100 dark:from-red-900 dark:to-red-800 rounded-lg p-3 sm:p-4 lg:p-6 border border-red-200 dark:border-red-700">
                <div class="flex items-center justify-between gap-2">
                    <div class="min-w-0">
                        <p class="text-xs sm:text-sm font-medium text-red-600 dark:text-red-300 uppercase tracking-wide truncate">Tidak
                            Aktif
                        </p>
            ...
            <!-- Guru Laki-laki -->
            <div class="bg-gradient-to-br from-sky-50 to-sky-100 dark:from-sky-900 dark:to-sky-800 rounded-lg p-3 sm:p-4 lg:p-6 border border-sky-200 dark:border-sky-700">
                <div class="flex items-center justify-between gap-2">
                    <div class="min-w-0">
                        <p class="text-xs sm:text-sm font-medium text-sky-600 dark:text-sky-300 uppercase tracking-wide truncate">
                            Laki-laki</p>
            ...
            <!-- Guru Perempuan -->
            <div class="bg-gradient-to-br from-pink-50 to-pink-100 dark:from-pink-900 dark:to-pink-800 rounded-lg p-3 sm:p-4 lg:p-6 border border-pink-200 dark:border-pink-700">
                <div class="flex items-center justify-between gap-2">
                    <div class="min-w-0">
                        <p class="text-xs sm:text-sm font-medium text-pink-600 dark:text-pink-300 uppercase tracking-wide truncate">
                            Perempuan
                        </p>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-3 lg:gap-4 mt-4 sm:mt-6">
            ...
            <div
                ...
                <div class="flex items-center justify-between gap-2">
                    <div class="min-w-0">
                        <p class="text-xs sm:text-sm font-medium text-amber-600 dark:text-amber-300 uppercase tracking-wide truncate">PNS
                        </p>
                        <p class="text-2xl sm:text-3xl font-bold text-amber-800 dark:text-amber-100 mt-1">
                            {{ number_format($counts['guru']['pns']) }}</p>
                    </div>
                    <i class="fas fa-id-badge text-3xl sm:text-4xl text-amber-300 dark:text-amber-600 flex-shrink-0"></i>
                </div>
            </div>

            <!-- Guru Non PNS -->
            <div class="bg-gradient-to-br from-lime-50 to-lime-100 dark:from-lime-900 dark:to-lime-800 rounded-lg p-3 sm:p-4 lg:p-6 border border-lime-200 dark:border-lime-700">
                <div class="flex items-center justify-between gap-2">
                    <div class="min-w-0">
                        <p class="text-xs sm:text-sm font-medium text-lime-600 dark:text-lime-300 uppercase tracking-wide truncate">Non PNS
                        </p>
            ...
            <div
                ...
                <div class="flex items-center justify-between gap-2">
                    <div class="min-w-0">
                        <p class="text-xs sm:text-sm font-medium text-fuchsia-600 dark:text-fuchsia-300 uppercase tracking-wide truncate">PPPK
                        </p>
                        <p class="text-2xl sm:text-3xl font-bold text-fuchsia-800 dark:text-fuchsia-100 mt-1">
                            {{ number_format($counts['guru']['pppk']) }}</p>
                    </div>
                    <i class="fas fa-certificate text-3xl sm:text-4xl text-fuchsia-300 dark:text-fuchsia-600 flex-shrink-0"></i>
                </div>
            </div>
        </div>
    </x-ui.card>
