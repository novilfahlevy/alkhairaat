    ...
    <div class="space-y-6 pb-60">
        ...
        <div class="rounded-lg bg-white p-6 shadow-md dark:bg-gray-900">
            ...
            <div class="mb-6 rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-900/30 dark:bg-blue-900/20">
                <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <p class="text-sm text-blue-700 dark:text-blue-400">
                        ...
                        ditambahkan atau dimodifikasi. File akan diproses secara otomatis oleh sistem.
                    </p>
            ...
            <div class="mb-6 rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-900/30 dark:bg-blue-900/20">
                <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <p class="text-sm text-blue-700 dark:text-blue-400">
                        Anda juga dapat mengunduh file template dari halaman <b>Data Murid</b> dengan melakukan ekspor ke format <code class="bg-blue-100 px-1 rounded">.xlsx</code>.
                    </p>
                    <a href="{{ route('sekolah.show-murid', $sekolah) }}" class="inline-flex items-center justify-center whitespace-nowrap rounded-lg border border-blue-300 bg-blue-100 px-4 py-2 text-sm font-medium text-blue-700 hover:bg-blue-200 dark:border-blue-800 dark:bg-blue-900/40 dark:text-blue-300 dark:hover:bg-blue-900/60 transition">
                        Halaman Data Murid
                    </a>
                </div>
            </div>
