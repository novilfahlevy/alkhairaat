...
@section('content')
    ...
    <div class="rounded-lg bg-white p-6 shadow-md dark:bg-gray-900">
        ...
        <!-- Form -->
        <form action="{{ route('sekolah.update', $sekolah) }}" method="POST" id="sekolahForm" x-data="{ isSubmitting: false }"
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                        ...
                        <div>
                            ...
                            <input type="text" name="bank_rekening" value="{{ old('bank_rekening', $sekolah->bank_rekening) }}" placeholder="Nama bank"
                        ...
                        <div>
                            ...
                            <input type="text" name="nomor_rekening" value="{{ old('nomor_rekening', $sekolah->nomor_rekening) }}" placeholder="No. rekening"
                        ...
                        <div>
                            ...
                            <input type="text" name="rekening_atas_nama" value="{{ old('rekening_atas_nama', $sekolah->rekening_atas_nama) }}" placeholder="Nama pemilik rekening"
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="alamat_kecamatan" value="{{ old('alamat_kecamatan', $sekolah->alamatList()->first()?->kecamatan ?? '') }}" 
                        ...
                        <div>
                            ...
                            <input type="text" name="alamat_kelurahan" value="{{ old('alamat_kelurahan', $sekolah->alamatList()->first()?->kelurahan ?? '') }}" 
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                            <div>
                                ...
                                <input type="text" name="alamat_rt" value="{{ old('alamat_rt', $sekolah->alamatList()->first()?->rt ?? '') }}" 
                                    placeholder="RT"
                            ...
                            <div>
                                ...
                                <input type="text" name="alamat_rw" value="{{ old('alamat_rw', $sekolah->alamatList()->first()?->rw ?? '') }}" 
                                    placeholder="RW"
                            ...
                            <div>
                                ...
                                <input type="text" name="alamat_kode_pos" value="{{ old('alamat_kode_pos', $sekolah->alamatList()->first()?->kode_pos ?? '') }}" 
                        ...
                        <div>
                            ...
                            <input type="text" name="alamat_koordinat_x" value="{{ old('alamat_koordinat_x', $sekolah->alamatList()->first()?->koordinat_x ?? '') }}" 
                                placeholder="-0.5417"
                        ...
                        <div>
                            ...
                            <input type="text" name="alamat_koordinat_y" value="{{ old('alamat_koordinat_y', $sekolah->alamatList()->first()?->koordinat_y ?? '') }}" 
