                    ...
                    <div>
                        ...
                        <select name="status"
                            ...
                            @foreach ($statusOptions as $status => $label)
                                <option value="{{ $status }}"
                                    {{ old('status', $sekolah->status) == $status ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
                        ...
                        <select name="provinsi_id" id="provinsi"
                            ...
                            @foreach ($provinsi as $prov)
                                <option value="{{ $prov->id }}"
                                    {{ old('provinsi_id', $sekolah->kabupaten?->provinsi_id) == $prov->id ? 'selected' : '' }}>
                                    {{ $prov->nama_provinsi }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <select name="kabupaten_id" id="kabupaten"
                            ...
                            @foreach ($kabupaten as $kab)
                                <option value="{{ $kab->id }}"
                                    {{ old('kabupaten_id', $sekolah->kabupaten_id) == $kab->id ? 'selected' : '' }}>
                                    {{ $kab->nama_kabupaten }}
                                </option>
                            @endforeach
                        </select>
