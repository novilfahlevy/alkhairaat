        ...
        @if ($currentTab === 'manual')
            <div id="tab-manual" role="tabpanel">
                ...
                <div class="rounded-lg bg-white p-6 shadow-md dark:bg-gray-900">
                    ...
                    @if ($errors->any())
                        <div
                            class="mb-6 rounded-lg bg-red-100 p-4 text-sm text-red-700 dark:bg-red-900/30 dark:text-red-400">
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" name="tahun_masuk"
                                            value="{{ old('tahun_masuk', date('Y')) }}" min="1900"
                                            max="{{ date('Y') + 1 }}"
                                    ...
                                    <div>
                                        ...
                                        <input type="tel" name="nomor_hp_ayah"
