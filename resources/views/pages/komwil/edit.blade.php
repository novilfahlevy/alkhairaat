...
@section('content')
    <div class="rounded-lg bg-white p-6 shadow-md dark:bg-gray-900 mb-50">
        <div class="mb-6">
            <h1 class="text-title-md mb-2 font-semibold text-gray-800 dark:text-white/90">Edit Komwil</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400">Edit akun Komisariat Wilayah dan atur sekolah naungan</p>
        </div>
        <form action="{{ route('manajemen.komwil.update', $user->id) }}" method="POST" id="komwilForm" x-data="{ isSubmitting: false }"
            ...
            <div class="mb-8">
                ...
                <div class="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-2">
                    <div x-data="{ show: false }">
                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Password Baru <span class="text-gray-500 text-xs">(Kosongkan jika tidak ingin diubah)</span></label>
                        <div class="relative">
                            ...
                            <button type="button" @click="show = !show" tabindex="-1"
                                ...
                                <svg x-show="show" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a9.956 9.956 0 012.293-3.95m3.36-2.676A9.956 9.956 0 0112 5c4.478 0 8.268 2.943 9.542 7a9.965 9.965 0 01-4.043 5.306M15 12a3 3 0 11-6 0 3 3 0 016 0zm6 6L3 3" />
                                </svg>
                            </button>
                        </div>
                        @error('password')
                                            ...
                                            @forelse ($kabupaten->sekolah as $sekolah)
                                                <label class="flex items-center">
                                                    <input type="checkbox" name="sekolah_ids[]" value="{{ $sekolah->id }}"
                                                        ...
                                                        {{ in_array($sekolah->id, old('sekolah_ids', $currentSekolahIds)) ? 'checked' : '' }}
            ...
            <div
                ...
                <a href="{{ route('manajemen.komwil.index') }}"
