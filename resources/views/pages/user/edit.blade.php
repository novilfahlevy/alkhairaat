...
@section('content')
    ...
    <div class="rounded-lg bg-white p-6 shadow-md dark:bg-gray-900">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                <div class="mb-4 md:mb-0">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                        Edit akun user dan atur hak akses sekolah
                    </p>
                </div>
        ...
        <!-- Form -->
        <form action="{{ route('user.update', $user->id) }}" method="POST" id="userForm" x-data="{ isSubmitting: false, role: '{{ old('role', $user->getFirstRole()) }}' }"
                    ...
                    @forelse ($sekolahByProvinsi as $provinsi => $kabupatenList)
                        <div class="border border-gray-200 dark:border-gray-700 rounded-lg" x-data="{ open: false, provinsiId: {{ $loop->index }} }">
                            <div
                                ...
                                <button type="button" @click.prevent.stop="window.checkAllProvinsi(provinsiId); open = true"
