                ...
                <tbody class="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-900">
                    @forelse($sekolahExternal as $item)
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800">
                            <td class="px-6 py-4 text-sm font-medium text-gray-900 dark:text-white/90">
                                {{ $item->nama_sekolah }}
                            </td>
                            ...
                            <td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-400">
                                <span class="inline-flex rounded-full bg-purple-100 px-2.5 py-0.5 text-xs font-medium text-purple-800 dark:bg-purple-900/30 dark:text-purple-300">
                            ...
                            <td class="px-6 py-4 text-sm font-medium">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <form action="{{ route('sekolah-external.destroy', $item->id_sekolah_external) }}" method="POST" class="inline"
            ...
            @forelse($sekolahExternal as $item)
                <div class="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                    <div class="mb-3 flex items-start justify-between">
                        <div class="flex-1">
                            <h3 class="font-semibold text-gray-900 dark:text-white/90">
                                {{ $item->nama_sekolah }}
                            </h3>
                    ...
                    <div class="flex items-center space-x-2 border-t border-gray-200 pt-3 dark:border-gray-700">
                        <a href="{{ route('sekolah-external.show', $item->id_sekolah_external) }}"
                        ...
                        <form action="{{ route('sekolah-external.destroy', $item->id_sekolah_external) }}" method="POST" class="flex-1"
                            onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="text-red-600 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300 w-full rounded-md bg-red-50 px-3 py-2 text-sm font-medium dark:bg-red-900/20">
                                Hapus
                            </button>
                        </form>
                    </div>
