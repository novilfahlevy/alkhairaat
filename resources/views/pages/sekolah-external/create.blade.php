...
@section('content')
    ...
    <div class="rounded-lg bg-white p-6 shadow-md dark:bg-gray-900">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                <div class="mb-4 md:mb-0">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                        Tambahkan sekolah external baru ke dalam sistem
                    </p>
                </div>
        ...
        <!-- Form -->
        <form action="{{ route('sekolah-external.store') }}" method="POST" x-data="{ isSubmitting: false }"
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                ...
                <div>
                    ...
                    <select id="id_jenis_sekolah" name="id_jenis_sekolah"
                        ...
                        @foreach ($jenisSekolah as $jenis)
                            <option value="{{ $jenis->id }}" @selected(old('id_jenis_sekolah') == $jenis->id)>
                                {{ $jenis->nama_jenis }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select id="id_bentuk_pendidikan" name="id_bentuk_pendidikan"
                        ...
                        @foreach ($bentukPendidikan as $bentuk)
                            <option value="{{ $bentuk->id }}" @selected(old('id_bentuk_pendidikan') == $bentuk->id)>
                                {{ $bentuk->nama }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <input type="text" id="kota_sekolah" name="kota_sekolah" value="{{ old('kota_sekolah') }}"
