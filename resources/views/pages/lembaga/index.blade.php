        ...
        <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">
                    Kelola data lembaga pendidikan Alkhairaat
                </p>
            </div>
            @can('manage_lembaga')
            <div>
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-4">
                ...
                <div>
                    ...
                    <input type="text" name="search" value="{{ request('search') }}" 
                           placeholder="Nama atau kode lembaga"
                ...
                <div class="flex items-end">
                    <button type="submit" 
                            class="bg-brand-500 hover:bg-brand-600 h-11 w-full rounded-lg px-4 text-sm font-medium text-white transition">
                        Filter
                    </button>
                </div>
            </div>
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="bg-gray-50 dark:bg-gray-800">
                    <tr>
                        ...
                        @canany(['manage_lembaga', 'access_lembaga'])
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-800">
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex items-center justify-end space-x-2">
                                ...
                                <form action="{{ route('lembaga.destroy', $item) }}" method="POST" class="inline-block"
