...
@section('content')
    ...
    <div class="rounded-lg bg-white p-6 shadow-md dark:bg-gray-900">
        ...
        <!-- Form -->
        <form action="{{ route('lembaga.update', $lembaga) }}" method="POST" id="lembagaForm" x-data="{ isSubmitting: false }"
                        ...
                        <select name="jenjang"
                            ...
                            @foreach ($jenjangOptions as $jenjang)
                                <option value="{{ $jenjang }}"
                                    {{ old('jenjang', $lembaga->jenjang) == $jenjang ? 'selected' : '' }}>
                                    {{ $jenjang }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <select name="status"
                            ...
                            @foreach ($statusOptions as $status => $label)
                                <option value="{{ $status }}"
                                    {{ old('status', $lembaga->status) == $status ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
                        ...
                        <select name="provinsi_id" id="provinsi"
                            ...
                            @foreach ($provinsi as $prov)
                                <option value="{{ $prov->id }}"
                                    {{ old('provinsi_id', $lembaga->kabupaten?->provinsi_id) == $prov->id ? 'selected' : '' }}>
                                    {{ $prov->nama_provinsi }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <select name="kabupaten_id" id="kabupaten"
                            ...
                            @foreach ($kabupaten as $kab)
                                <option value="{{ $kab->id }}"
                                    {{ old('kabupaten_id', $lembaga->kabupaten_id) == $kab->id ? 'selected' : '' }}>
                                    {{ $kab->nama_kabupaten }}
                                </option>
                            @endforeach
                        </select>
