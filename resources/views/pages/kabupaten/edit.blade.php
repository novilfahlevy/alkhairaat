    ...
    <div class="rounded-lg bg-white p-6 shadow-md dark:bg-gray-900 max-w-2xl">
        <form action="{{ route('kabupaten.update', $kabupaten) }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="kode_kabupaten" name="kode_kabupaten" value="{{ old('kode_kabupaten', $kabupaten->kode_kabupaten) }}"
            ...
            <div class="mb-6">
                ...
                <input type="text" id="nama_kabupaten" name="nama_kabupaten" value="{{ old('nama_kabupaten', $kabupaten->nama_kabupaten) }}"
