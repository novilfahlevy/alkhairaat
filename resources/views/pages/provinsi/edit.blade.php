    ...
    <div class="rounded-lg bg-white p-6 shadow-md dark:bg-gray-900 max-w-2xl">
        <form action="{{ route('provinsi.update', $provinsi) }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="kode_provinsi" name="kode_provinsi" value="{{ old('kode_provinsi', $provinsi->kode_provinsi) }}"
            ...
            <div class="mb-6">
                ...
                <input type="text" id="nama_provinsi" name="nama_provinsi" value="{{ old('nama_provinsi', $provinsi->nama_provinsi) }}"
