...
@section('content')
    <div class="rounded-lg bg-white p-6 shadow-md dark:bg-gray-900 mb-50">
        <div class="mb-6">
            <h1 class="text-title-md mb-2 font-semibold text-gray-800 dark:text-white/90">Edit Guru</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400">Edit akun Guru dan atur sekolah naungan</p>
        </div>
        <form action="{{ route('manajemen.guru.update', $user->id) }}" method="POST" id="guruForm" x-data="{ isSubmitting: false }"
