...
@section('content')
    ...
    <div class="space-y-6 pb-60">
            ...
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                        Masukkan informasi guru yang akan ditambahkan ke sistem
                    </p>
                </div>
        ...
        <!-- Form -->
        <form action="{{ route('guru.store') }}" method="POST" class="rounded-lg bg-white p-6 shadow-md dark:bg-gray-900">
            @csrf
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="nama_gelar_depan" name="nama_gelar_depan" value="{{ old('nama_gelar_depan') }}"
                    ...
                    <div>
                        ...
                        <input type="text" id="nama_gelar_belakang" name="nama_gelar_belakang" value="{{ old('nama_gelar_belakang') }}"
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="kontak_wa_hp" name="kontak_wa_hp" value="{{ old('kontak_wa_hp') }}"
                    ...
                    <div>
                        ...
                        <input type="email" id="kontak_email" name="kontak_email" value="{{ old('kontak_email') }}"
                    ...
                    <div>
                        ...
                        <input type="text" id="bank_rekening" name="bank_rekening" value="{{ old('bank_rekening') }}"
                    ...
                    <div>
                        ...
                        <input type="text" id="rekening_atas_nama" name="rekening_atas_nama" value="{{ old('rekening_atas_nama') }}"
            ...
            <!-- Jabatan Section -->
            <div class="mt-8 border-t border-gray-200 pt-8 dark:border-gray-700" x-data="schoolAssignments()">
