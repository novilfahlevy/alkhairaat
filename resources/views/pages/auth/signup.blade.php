                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    ...
                                    <select id="lembaga_id" name="lembaga_id"
                                        class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 @error('lembaga_id') border-red-500 @enderror">
                                        <option value="">-- Pilih Lembaga --</option>
                                        @foreach ($lembagaList ?? [] as $lembaga)
                                            <option value="{{ $lembaga->id }}" {{ old('lembaga_id') == $lembaga->id ? 'selected' : '' }}>
                                                {{ $lembaga->nama }} ({{ $lembaga->kode_lembaga }})
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('lembaga_id')
                                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                    @enderror
                                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Pilih lembaga tempat Anda bertugas (opsional)</p>
                                </div>
                                <!-- Password -->
                                <div>
                                    <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                ...
                                <div>
                                    ...
                                    <div x-data="{ showPassword: false }" class="relative">
                                        <input :type="showPassword ? 'text' : 'password'" name="password_confirmation" placeholder="Konfirmasi password"
                                ...
                                <div>
                                    <div x-data="{ checkboxToggle: false }">
                                        <label for="checkboxLabelOne"
                                            ...
                                            <div class="relative">
                                                <input type="checkbox" id="checkboxLabelOne" name="agree" class="sr-only" @change="checkboxToggle = !checkboxToggle" />
                ...
                <div class="z-1 flex items-center justify-center">
                    ...
                    <div class="flex max-w-xs flex-col items-center">
                        <a href="/" class="mb-4 block">
                            <img src="/images/logo_alkhairaat.png" alt="Logo" />
                        </a>
