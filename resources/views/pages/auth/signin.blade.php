...
@section('content')
    <div class="relative z-1 bg-white p-6 sm:p-0 dark:bg-gray-900">
        <div class="relative flex h-screen w-full flex-col justify-center sm:p-0 lg:flex-row dark:bg-gray-900">
            <!-- Form -->
            <div class="flex w-full flex-1 flex-col lg:w-1/2" x-data="{ isSubmitting: false }"
                x-on:submit="isSubmitting = true; $el.submit();">
                                    ...
                                    <div>
                                        <button type="submit"
                                            ...
                                            <template x-if="isSubmitting">
                                                <svg class="mr-2 h-5 w-5 animate-spin text-white"
