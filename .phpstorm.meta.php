...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/novilfahlevy/Projects/alkhairaat/public/storage' => 'string',
            ...
            'logging.channels.murid_bulk_import.driver' => 'string',
            'logging.channels.murid_bulk_import.path' => 'string',
            'logging.channels.murid_bulk_import.level' => 'string',
            'logging.channels.murid_bulk_import.replace_placeholders' => 'boolean',
            'logging.channels.guru_bulk_import.driver' => 'string',
            'logging.channels.guru_bulk_import.path' => 'string',
            'logging.channels.guru_bulk_import.level' => 'string',
            'logging.channels.guru_bulk_import.replace_placeholders' => 'boolean',
            'mail.default' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/novilfahlevy/Projects/alkhairaat/public/storage','logging.default',
...
'logging.channels.null.driver','logging.channels.null.handler','logging.channels.emergency.path','logging.channels.murid_bulk_import.driver','logging.channels.murid_bulk_import.path',
'logging.channels.murid_bulk_import.level','logging.channels.murid_bulk_import.replace_placeholders','logging.channels.guru_bulk_import.driver','logging.channels.guru_bulk_import.path','logging.channels.guru_bulk_import.level',
'logging.channels.guru_bulk_import.replace_placeholders','mail.default','mail.mailers.smtp.transport','mail.mailers.smtp.scheme','mail.mailers.smtp.url',
...
'excel.temporary_files.local_permissions','excel.temporary_files.remote_disk','excel.temporary_files.remote_prefix','excel.temporary_files.force_resync_remote','ide-helper.filename',
...
'generated::TsIuk09uHKJJ37Lh','login','generated::oo5qMxDGPkEQmQEB','register','generated::KtqDQBYCnqf82Eov',
'logout','dashboard','profile','calendar','form-elements',
'basic-tables','blank','line-chart','bar-chart','alerts',
'avatars','badges','buttons','images','videos',
'provinsi.index','provinsi.create','provinsi.store','provinsi.show','provinsi.edit',
'provinsi.update','provinsi.destroy','kabupaten.index','kabupaten.create','kabupaten.store',
'kabupaten.show','kabupaten.edit','kabupaten.update','kabupaten.destroy','sekolah.check-kode',
'sekolah.index','sekolah.create','sekolah.store','sekolah.get_kabupaten','sekolah.show',
'sekolah.show-murid','sekolah.show-guru','sekolah.edit','sekolah.update','sekolah.destroy',
'sekolah.create-murid','sekolah.store-murid','sekolah.check-nisn','sekolah.get-existing-murid','sekolah.store-existing-murid',
'sekolah.store-murid-file','sekolah.download-template','sekolah.show-detail-murid','sekolah.edit-murid','sekolah.update-murid',
'sekolah.delete-murid','sekolah.create-guru','sekolah.check-nik-guru','sekolah.store-guru','sekolah.get-existing-guru',
'sekolah.store-existing-guru','sekolah.store-guru-file','sekolah.download-guru-template','sekolah.show-detail-guru','sekolah.edit-guru',
'sekolah.update-guru','sekolah.delete-guru','sekolah.add-jabatan-guru','sekolah.delete-jabatan-guru','sekolah-external.index',
'sekolah-external.create','sekolah-external.store','sekolah-external.show','sekolah-external.edit','sekolah-external.update',
'sekolah-external.destroy','user.index','user.create','user.store','user.show',
'user.edit','user.update','user.destroy','manajemen.komwil.index','manajemen.komwil.create',
'manajemen.komwil.store','manajemen.komwil.show','manajemen.komwil.edit','manajemen.komwil.update','manajemen.komwil.destroy',
'manajemen.komda.index','manajemen.komda.create','manajemen.komda.store','manajemen.komda.show','manajemen.komda.edit',
'manajemen.komda.update','manajemen.komda.destroy','manajemen.akun-sekolah.index','manajemen.akun-sekolah.create','manajemen.akun-sekolah.store',
'manajemen.akun-sekolah.show','manajemen.akun-sekolah.edit','manajemen.akun-sekolah.update','manajemen.akun-sekolah.destroy','reports',
'export','error-404','storage.local',);
        registerArgumentsSet('views', 
'components.calender-area','components.common.common-grid-shape','components.common.component-card','components.common.dropdown-menu','components.common.page-breadcrumb',
'components.common.preloader','components.common.table-dropdown','components.common.theme-toggle','components.dashboard.counts','components.ecommerce.customer-demographic',
'components.ecommerce.monthly-sale','components.ecommerce.monthly-target','components.ecommerce.recent-orders','components.ecommerce.statistics-chart','components.form.date-picker',
'components.form.form-elements.checkbox-component','components.form.form-elements.default-inputs','components.form.form-elements.dropzone','components.form.form-elements.file-input-example','components.form.form-elements.input-group',
'components.form.form-elements.input-states','components.form.form-elements.radio-buttons','components.form.form-elements.select-inputs','components.form.form-elements.text-area-inputs','components.form.form-elements.toggle-switch',
'components.form.input.radio','components.form.select.multiple-select','components.header.notification-dropdown','components.header.user-dropdown','components.pagination',
'components.profile.address-card','components.profile.personal-info-card','components.profile.profile-card','components.sekolah.galeri','components.sekolah.peta',
'components.sekolah.tabel-guru','components.sekolah.tabel-murid','components.tables.basic-tables.basic-tables-five','components.tables.basic-tables.basic-tables-four','components.tables.basic-tables.basic-tables-one',
'components.tables.basic-tables.basic-tables-three','components.tables.basic-tables.basic-tables-two','components.ui.alert','components.ui.avatar','components.ui.badge',
'components.ui.button','components.ui.card','components.ui.modal','components.ui.table','components.ui.youtube-embed',
'layouts.app','layouts.app-header','layouts.backdrop','layouts.fullscreen-layout','layouts.sidebar',
'layouts.sidebar-widget','pages.akun-sekolah.create','pages.akun-sekolah.edit','pages.akun-sekolah.index','pages.auth.signin',
'pages.auth.signup','pages.blank','pages.calender','pages.chart.bar-chart','pages.chart.line-chart',
'pages.dashboard','pages.errors.error-404','pages.form.form-elements','pages.kabupaten.create','pages.kabupaten.edit',
'pages.kabupaten.index','pages.kabupaten.show','pages.komda.create','pages.komda.edit','pages.komda.index',
'pages.komwil.create','pages.komwil.edit','pages.komwil.index','pages.profile','pages.provinsi.create',
'pages.provinsi.edit','pages.provinsi.index','pages.provinsi.show','pages.sekolah-external.create','pages.sekolah-external.edit',
'pages.sekolah-external.index','pages.sekolah-external.show','pages.sekolah.create','pages.sekolah.edit','pages.sekolah.guru.create',
'pages.sekolah.guru.detail','pages.sekolah.guru.edit','pages.sekolah.guru.existing','pages.sekolah.guru.guru','pages.sekolah.guru.tambah-guru-files',
'pages.sekolah.guru.tambah-guru-tabs','pages.sekolah.index','pages.sekolah.murid.detail','pages.sekolah.murid.edit','pages.sekolah.murid.murid',
'pages.sekolah.murid.tambah-murid','pages.sekolah.murid.tambah-murid-existing','pages.sekolah.murid.tambah-murid-files','pages.sekolah.murid.tambah-murid-tabs','pages.sekolah.show',
'pages.tables.basic-tables','pages.ui-elements.alerts','pages.ui-elements.avatars','pages.ui-elements.badges','pages.ui-elements.buttons',
'pages.ui-elements.images','pages.ui-elements.videos','pages.user.create','pages.user.edit','pages.user.index',
'laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.copy-button','laravel-exceptions-renderer::components.editor','laravel-exceptions-renderer::components.header',
