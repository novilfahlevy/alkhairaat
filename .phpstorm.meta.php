...
'generated::nQFtlCCukUlypUw8','login','generated::3mT0TTWtBWK28Pzi','register','generated::bIll1gZamk5kjPvL',
'logout','dashboard','calendar','profile','form-elements',
...
'kabupaten.show','kabupaten.edit','kabupaten.update','kabupaten.destroy','sekolah.index',
'sekolah.create','sekolah.store','sekolah.get_kabupaten','sekolah.show','sekolah.edit',
'sekolah.update','sekolah.destroy','sekolah-external.index','sekolah-external.create','sekolah-external.store',
'sekolah-external.show','sekolah-external.edit','sekolah-external.update','sekolah-external.destroy','user.index',
'user.create','user.store','user.show','user.edit','user.update',
'user.destroy','manajemen.komwil.index','manajemen.komwil.create','manajemen.komwil.store','manajemen.komwil.show',
'manajemen.komwil.edit','manajemen.komwil.update','manajemen.komwil.destroy','manajemen.komda.index','manajemen.komda.create',
'manajemen.komda.store','manajemen.komda.show','manajemen.komda.edit','manajemen.komda.update','manajemen.komda.destroy',
'manajemen.akun-sekolah.index','manajemen.akun-sekolah.create','manajemen.akun-sekolah.store','manajemen.akun-sekolah.show','manajemen.akun-sekolah.edit',
'manajemen.akun-sekolah.update','manajemen.akun-sekolah.destroy','reports','export','error-404',
'storage.local',);
...
'components.form.input.radio','components.form.select.multiple-select','components.header.notification-dropdown','components.header.user-dropdown','components.profile.address-card',
'components.profile.personal-info-card','components.profile.profile-card','components.tables.basic-tables.basic-tables-five','components.tables.basic-tables.basic-tables-four','components.tables.basic-tables.basic-tables-one',
...
'components.ui.button','components.ui.modal','components.ui.youtube-embed','layouts.app','layouts.app-header',
'layouts.backdrop','layouts.fullscreen-layout','layouts.sidebar','layouts.sidebar-widget','pages.akun-sekolah.create',
'pages.akun-sekolah.edit','pages.akun-sekolah.index','pages.auth.signin','pages.auth.signup','pages.blank',
'pages.calender','pages.chart.bar-chart','pages.chart.line-chart','pages.dashboard','pages.errors.error-404',
'pages.form.form-elements','pages.kabupaten.create','pages.kabupaten.edit','pages.kabupaten.index','pages.kabupaten.show',
'pages.komda.create','pages.komda.edit','pages.komda.index','pages.komwil.create','pages.komwil.edit',
'pages.komwil.index','pages.profile','pages.provinsi.create','pages.provinsi.edit','pages.provinsi.index',
'pages.provinsi.show','pages.sekolah-external.create','pages.sekolah-external.edit','pages.sekolah-external.index','pages.sekolah-external.show',
'pages.sekolah.create','pages.sekolah.edit','pages.sekolah.index','pages.sekolah.show','pages.tables.basic-tables',
'pages.ui-elements.alerts','pages.ui-elements.avatars','pages.ui-elements.badges','pages.ui-elements.buttons','pages.ui-elements.images',
'pages.ui-elements.videos','pages.user.create','pages.user.edit','pages.user.index','laravel-exceptions-renderer::components.card',
